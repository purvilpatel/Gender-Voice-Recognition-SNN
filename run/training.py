...
def train(filename):
	...
	util.print_list_to_file(female_conductance, "./csv/female_conductance.csv", "a", str("female_conductance "+filename))
	util.print_list_to_file(male_conductance, "./csv/male_conductance.csv", "a", str("male_conductance "+filename))
...
util.print_list_to_file(female_output_neuron.get_output(), "./csv/female_voltage.csv", "a", str("female_voltage"))
util.print_list_to_file(male_output_neuron.get_output(), "./csv/female_voltage.csv", "a", str("male_voltage"))
