...
filename = "arctic_a0001_2_male.wav"
...
def train(filename):
	...
	util.print_list_to_file(i_inj, "./csv/i_inj"+ str(teacher) + ".csv", "a", str("i_injected " + filename))
...
plt.subplot(211)
plt.title("female_conductance")
plt.plot(female_conductance[0:100])

plt.subplot(212)
plt.plot(male_conductance[0:100])
plt.title("male_conductance")
